...
export interface FactoryDeploy {
  $$type: 'FactoryDeploy'
  queryId: bigint
  cashback: Address
}
...
export interface DeployNFT721Storage {
...
export interface DeployNFT721Collection {
...
export interface ReportRoyaltyParams {
...
export interface HiFromDeployNFT721Storage {
...
export interface HiFromDeployNFT721Collection {
...
export interface CollectionDeploy {
...
export interface StorageDeploy {
  $$type: 'StorageDeploy'
  sourceNftContractAddress: Address
  isOriginal: boolean
  key: bigint
...
export interface ValidatorsToRewards {
...
export interface RewardValidator {
...
export interface AddNewValidatorEvent {
...
export interface RewardValidatorEvent {
...
export interface UnLock721Event {
  $$type: 'UnLock721Event'
  to: Address
  tokenId: bigint
  contractAddress: Address
...
const Bridge_errors: Record<number, { message: string }> = {
