...
const secretLockListener = async ({ config, secretChainConfig, wallets }: ISecretLockListener) => {

    const { contractAddress, rpcURL, lastBlock: lastBlock_, chain, chainId } = secretChainConfig;
