...
const multiversXContractListener = async ({ eventIdentifier, multiversXChainConfig, config, wallets, jobName }: IMultiversXContractListener) => {
    ...
    await createJobWithWorker<IProcessLogs>({
        jobData: { gatewayURL: multiversXChainConfig.gatewayURL, eventIdentifier, multiversXChainConfig, config, wallets },
