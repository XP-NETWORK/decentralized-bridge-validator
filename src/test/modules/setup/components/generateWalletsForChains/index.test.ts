...
describe('generateWalletsForChains', () => {
    ...
    const testCases = [
        ...
        {
            description:
                'should generate new secrets if existing secrets are invalid',
            readJsonFileStubResolves: { invalid: 'data' },
            expectedWriteFileCalled: true,
        },
        {
            description:
                'should generate new secrets if no secrets file is found',
    ...
    testCases.forEach(
        ({
            description,
            readJsonFileStubResolves,
            readJsonFileStubRejects,
            expectedWriteFileCalled,
        }) => {
            it(description, async () => {
                ...
                expect(writeFileStub.calledOnce).to.equal(
                    expectedWriteFileCalled,
                );
