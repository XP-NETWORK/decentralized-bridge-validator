...
describe('approveLock', () => {
    ...
    const testCases = [
        ...
        {
            approveLockNft: sinon.stub().rejects({
        ...
        },
        {
            ...
            description:
                "should throw error if error is not 'Signature already used'",
        },
    ];
            ...
            if (expectedToThrow) {
                try {
                    await approveLock({
                        ...
                        wallets: mockWallets,
                        destinationChainObject: storageConfig,
                        storageContract,
                        txChain,
                    });
                } catch (error) {
