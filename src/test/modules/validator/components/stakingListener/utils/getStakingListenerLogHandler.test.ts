    ...
    it("should be able to approve stake", async () => {
        ...
        await handleLog({
            log: {
                ...
                transactionHash: '0x9f82e0133481e667af275a047daa7113fce293101c2af792fed5676df6ee5ada',
                transactionIndex: BigInt(1),
                blockHash: '0x89fd9da1073ee98652c17b1d5700cb10a79fcc9262bc63dcf4e1fb75ecf8616a',
                logIndex: BigInt(9),
                removed: false
            }
        });
