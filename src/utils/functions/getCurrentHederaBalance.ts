...
import { IEvmChainConfigAndEvmWallet, IHederaChainConfigAndEvmWallet, IStakingChainConfigAndEvmWallet } from '@src/types';


const getCurrentHederaBalance = async (configs: IHederaChainConfigAndEvmWallet | IStakingChainConfigAndEvmWallet): Promise<bigint> => {
    try {
        const rpc = "stakingChainConfig" in configs ? configs.stakingChainConfig.rpcURL : configs.hederaChainConfig.rpcURL;
