...
import { IEvmChainConfigAndEvmWallet, IHederaChainConfigAndEvmWallet } from "@src/types";

const getHederaBridgeContract = ({ hederaChainConfig, evmWallet }: IHederaChainConfigAndEvmWallet): Bridge => {
